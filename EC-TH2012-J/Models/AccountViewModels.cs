...
namespace EC_TH2012_J.Models
{
    ...
    {
        [Required(ErrorMessage = "Vui lòng không được để trống", AllowEmptyStrings = false)]
        [Display(Name = "Tên đăng nhập")]
        public string UserName { get; set; }
    ...
    public class RegisterViewModel
    {
        ...
        [Required(ErrorMessage = "Vui lòng cung cấp họ và tên", AllowEmptyStrings = false)]
        [Display(Name = "Họ tên")]
        ...
        [Required(ErrorMessage = "Vui lòng nhap mật khẩu", AllowEmptyStrings = false)]
        [StringLength(100, ErrorMessage = "{0} phải ít nhất {2} ký tự.", MinimumLength = 6)]
        [DataType(DataType.Password)]
        [Display(Name = "Mật khẩu")]
        public string Password { get; set; }
