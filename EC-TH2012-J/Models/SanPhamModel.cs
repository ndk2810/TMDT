    ...
    public class SanPhamModel
    {
        ...
        public List<SanPhamDTO> GetAllSP()
        {
            return (from a in db.SanPhams
                              join b in db.LoaiSPs
                              on a.LoaiSP equals b.MaLoai
        ...
        internal string ThemSP(SanPham sanpham)
        {
            ...
            //them barcode
            sanpham.Barcode = objbar.generateBarcode();
            sanpham.BarcodeImg = objbar.getBarcodeImage(sanpham.Barcode, sanpham.TenSP);
